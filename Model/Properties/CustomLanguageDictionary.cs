...
public class CustomLanguageDictionary : INotifyPropertyChanged
{
    ...
    public CustomLanguageDictionary() { }

    public CustomLanguageDictionary(Localization.Lang language)
    {
        Language = language;
    }
    public CustomLanguageDictionary(string name, string desc, Localization.Lang language)
    {
        this.Name = name;
